...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    ...
    @if ($message = Session::get('alert-product'))
    <br />
                    ...
                    <div class="card mb-3 box-shadow">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                ?>
                                <a href="{{ URl('categories-product/'.$produk->id) }}"><img src="{{ $path }}" class="img-thumbnail img-preview" style="max-width: 75%; height: auto;"></a>
                            </div>
                            ...
                            <a type="button" class="btn btn-md btn-block btn-outline-success" href="{{ URl('categories-product/'.$produk->id) }}">Lihat Produk</a>
                        </div>
                    </div>
                </div>
                @endforeach
