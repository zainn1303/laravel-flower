...
<form class="form-signin" method="post" action="{{ URL('manager-change-password') }}">
    @csrf
    <center>
        <h1 class="h3 mb-3 font-weight-normal">Change Password | Manager</h1>
    </center>
    @if ($message = Session::get('alert-change-password-manager'))
