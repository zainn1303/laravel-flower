...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    @if ($message = Session::get('alert-login-manager'))
    ...
    <h1 class="display-4">Halo, {{ $data_manager->name }}</h1>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <a type="button" class="btn btn-md btn-block btn-outline-primary" href="{{ URl('manager-categories-product/'.$cat->id) }}">Lihat Semua Produk</a>
                        </div>
                    </div>
                </div>
                @endforeach
